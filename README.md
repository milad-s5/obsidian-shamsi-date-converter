...
- **👁️ Rendered Date Display**: Optionally show the Shamsi date beside ISO Gregorian dates in Reading view and Live Preview without changing the note
...
- **Show Shamsi dates beside Gregorian dates**: When enabled, displays the Shamsi equivalent beside dates such as `2026-09-01` in Reading view and Live Preview. This is disabled by default and does not write anything to the note.

### Rendered Date Display

Enable **Show Shamsi dates beside Gregorian dates** in the plugin settings to see dates like this in Reading view and Live Preview:

```text
2026-09-01 (1405/06/10)
```

The original Markdown remains unchanged. The display supports ISO dates with either `-` or `/` separators. Source mode is not modified.
